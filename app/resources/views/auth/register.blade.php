...
<head>
    ...
    <title>Daftar - Perpustakaan Keliling</title>
    ...
    <div>
        <div class="register-container">
            <div class="register-header">
                ...
                <h1>📚 Daftar Akun</h1>
                <p>Bergabunglah dengan Perpustakaan Keliling</p>
            </div>
            ...
            <div class="register-form">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        @error('email')
                            @if($message !== 'Email tidak sama dengan konfirmasi email.')
                            <div class="error-message">{{ $message }}</div>
                            @endif
                        @enderror
			    ...
			    placeholder="konfirmasi@email.com"
                            value="{{ old('email_confirmation') }}"
                            class="{{ $errors->has('email_confirmation') ? 'error' : '' }}"
                        >
